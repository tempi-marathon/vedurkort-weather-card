...
- Optional **weather alerts** summary under the location title (via [CAP Alerts](https://github.com/seevee/cap_alerts) or core MeteoAlarm), with a detail dialog on tap
